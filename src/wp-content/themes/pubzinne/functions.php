...
if ( ! function_exists( 'pubzinne_exists_gdpr_framework' ) ) {
	function pubzinne_exists_gdpr_framework() {
...
if (is_admin()) {
	require_once pubzinne_get_file_dir( 'includes/fixes/fix_urls.php' );
}
