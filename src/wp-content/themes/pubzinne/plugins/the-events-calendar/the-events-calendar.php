...
if ( ! function_exists( 'pubzinne_tribe_events_theme_setup9' ) ) {
	...
	function pubzinne_tribe_events_theme_setup9() {
		if ( pubzinne_exists_tribe_events() ) {
			...
			add_filter( 'tribe_get_start_time', 'pubzinne_tribe_events_get_start_time',10 ,2 );
			add_filter( 'tribe_get_end_time', 'pubzinne_tribe_events_get_end_time',10 ,2 );		
		}
		if ( is_admin() ) {
...
// Time Format for event start time
if (!function_exists('pubzinne_tribe_events_get_start_time')){
	function pubzinne_tribe_events_get_start_time($tribe_format_date, $event) {
		$start_date = '';
...
if (!function_exists('pubzinne_tribe_events_get_end_time')){
	function pubzinne_tribe_events_get_end_time($tribe_format_date, $event) {
		$end_date = '';
		if ( class_exists( 'Tribe__Events__Timezones' ) ) {
