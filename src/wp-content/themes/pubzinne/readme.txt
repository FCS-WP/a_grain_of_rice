...
WordPress version: required at least 5.0, tested up to 6.6.2
...
Please install and activate it before starting to use the theme Pubzinne.
...
Theme documentation is available on https://pubzinne.axiomthemes.com/doc/
