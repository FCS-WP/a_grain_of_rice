...
.sc_chat_content .sc_chat_result .sc_chat_list .sc_chat_list_item_user .sc_chat_list_item_content {
    font-size: {$fonts['p_font-size']}
    line-height: {$fonts['p_line-height']}
}
...
#rtb-date_root .picker__button--clear:hover, 
#rtb-date_root .picker__button--today:hover, 
#rtb-date_root .picker__button--close:hover,
...
.picker__nav--next:before {
	border-left-color: {$colors['text_dark']}
}
...
.sc_igenerator .sc_igenerator_form_settings {
  background-color: {$colors['bg_color']};
  box-shadow: 0 0 10px {$colors['alter_bg_color_04']};
}
