				...
				if ( $need_image ) {
					?><div class="team_member_featured">
						<div class="team_member_avatar">
							<?php
							the_post_thumbnail(
												apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('team'), 'team-single'),
				...
				?><div class="team_member_description"><?php
					...
					if ( $need_info ) {
						...
						<div class="team_member_brief_info">
							<h5 class="team_member_brief_info_title"><?php esc_html_e('Brief info', 'pubzinne'); ?></h5>
